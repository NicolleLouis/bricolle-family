...
class TestArtifactSalvageMarketSummaryService:
    def test_build_sections_builds_city_rows_and_threshold_colors(self):
        ...
        shard_t6 = _create_object("TEST_T6_RUNE_PRICE", ObjectType.RUNE, 6)
