...
class TestMercenaryJacketPriceRefreshService:
    def test_refresh_prices_fetches_all_mercenary_jackets(self):
        fetcher = FakeFetcher()
        ...
        MercenaryJacketPriceRefreshService(fetcher=fetcher).refresh_prices()
