...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('habit_tracker', '0006_remove_bazaarrun_archetype'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='archetype',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='habit_tracker.bazaararchetype'),
        ),
    ]
